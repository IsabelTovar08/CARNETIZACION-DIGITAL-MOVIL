...
export const styles = StyleSheet.create({
  ...
  logo: { width: 72, height: 72, resizeMode: 'contain', alignSelf: 'center', marginBottom: 12 },

  title: { fontSize: 32, fontWeight: '900', color: '#123C56', textAlign: 'center', marginBottom: 10 },
